...
$(document).ready(function() {
    ...
    $("body").prepend(navbar);
    var navbars = $("<style>#navbar {position: relative; text-align: center;} table {border: 1px solid black;} td {padding-left: 10px; padding-right: 10px; border: 1px dashed black;} a {text-decoration: none;}</style>");
    $("head").append(navbars);
    navbarResize();
});
